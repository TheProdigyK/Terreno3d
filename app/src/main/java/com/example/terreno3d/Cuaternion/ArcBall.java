package com.example.terreno3d.Cuaternion;
...
*
* Si el punto est� fuera de la esfera... (longitud2 > 1)
*/
if (longitud2 > 1.0f) {
/* Calcula un factor de normalizaci�n (radio / sqrt(longitud2)) */
...
/* Obtiene el vector V */
obtieneVector(V, x, y);
/* Retorna el cuaterni�n equivalente a la rotaci�n. */
if (q != null) {
...
q.y = Normal.y;
q.z = Normal.z;
/* w = (theta / 2), donde theta es el �ngulo de rotaci�n */
