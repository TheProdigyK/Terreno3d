...
public class SprunceWood {
    ...
    public SprunceWood(Context ctx) {
        this.context = ctx;
        /* Lee los v�rtices */
        objLoader = new ObjLoader(context, "Sprunce/Spruce wood.obj");
        objLoader2 = new ObjLoader(context, "Sprunce/Spruce wood2.obj");
