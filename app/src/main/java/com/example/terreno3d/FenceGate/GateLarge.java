...
public class GateLarge {
    ...
    public GateLarge(Context ctx) {
        this.context = ctx;
        /* Lee los v�rtices */
        objLoader = new ObjLoader(context, "FenceGate/Fence ver. 1.obj");
        objLoader2 = new ObjLoader(context, "FenceGate/Fence ver. 1-2.obj");
