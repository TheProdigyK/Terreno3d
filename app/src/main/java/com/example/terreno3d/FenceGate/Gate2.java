...
public class Gate2 {
    ...
    public Gate2(Context ctx) {
        this.context = ctx;
        /* Lee los v�rtices */
        objLoader = new ObjLoader(context, "FenceGate/Fence Gate (Right Part) ver. 1.obj");
        objLoader2 = new ObjLoader(context, "FenceGate/Fence Gate (Right Part) ver. 1-2.obj");
