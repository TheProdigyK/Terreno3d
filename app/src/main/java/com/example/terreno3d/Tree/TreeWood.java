package com.example.terreno3d.Tree;
...
public class TreeWood {
    ...
    public TreeWood(Context ctx) {
        this.context = ctx;
        /* Lee los v�rtices */
        objLoader = new ObjLoader(context, "Tree/Tree wood.obj");
        objLoader2 = new ObjLoader(context, "Tree/Tree wood2.obj");
    ...
    public void dibuja(GL10 gl) {
        ...
        gl.glColor4f(61/255f, 47/255f, 38/255f, 0);

        /* Dibuja el cubo */
        gl.glDrawElements(GL10.GL_TRIANGLES, objLoader.normals.length,
                GL10.GL_UNSIGNED_SHORT, bufIndices);

        gl.glColor4f(90/255f, 70/255f, 47/255f, 0);
