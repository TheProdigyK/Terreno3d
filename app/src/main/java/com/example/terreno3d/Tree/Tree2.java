...
public class Tree2 {
    ...
    public Tree2(Context ctx) {
        this.context = ctx;
        /* Lee los v�rtices */
        objLoader = new ObjLoader(context, "Tree/Tree ver. 2.obj");
        objLoader2 = new ObjLoader(context, "Tree/Tree ver. 2-2.obj");
        objLoader3 = new ObjLoader(context, "Tree/Tree ver. 2-3.obj");
    ...
    public void dibuja(GL10 gl) {
        ...
        gl.glColor4f(45/255f, 101/255f, 52/255f, 0);
